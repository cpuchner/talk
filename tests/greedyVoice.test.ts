import { Dialogue, talk } from '../src/talk'

const inputData: Dialogue = [
  { 
    role: 'assistant',
    content: 'God, you can really be a silly billy..',
  },
  { 
    role: 'user',
    content: 'Wait, why? Why am I a silly billy? I know I did that thing.. but..',
  },
];
